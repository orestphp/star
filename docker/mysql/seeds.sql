...
-- ============================================================================
INSERT INTO `customers` (`id`, `phone`, `created_at`) VALUES
(4, '+1-555-0198', '2026-01-05 14:00:00'), -- Maps to John Doe
(5, '+44-20-7946-0958', '2026-01-06 09:30:00'), -- Maps to Jane Smith
(6, NULL, '2026-01-10 16:45:00'); -- Maps to Bob Johnson (Inactive)
...
-- Initial activities for general accounts
...
-- High-Volume Streams for Customer ID 4 (John Doe / Acme Corp)
-- This scales chronological lookup rendering logic out across multiple weeks
